...
class AppLocalizations {
  ...
  static const _translations = {
    'en': {
      ...
      'checkin_title_hint': 'What do you want to check today?',
      'quick_checkin': 'Quick check-in',
      'checkin_empty': 'No check-ins yet',
    ...
    'ar': {
      ...
      'vet_visits': 'زيارات الطبيب البيطري',
      'add_visit': 'إضافة زيارة',
      'clinic': 'العيادة',
      'doctor': 'الطبيب',
      'reason': 'السبب',
      'upcoming_visit': 'زيارة قادمة',
      'completed_visit': 'تمت',
      ...
      'untitled': 'بدون عنوان',
      'save': 'حفظ',
      'daily_checkins': 'مهام يومية',
      'add_checkin': 'إضافة تحقق',
      'checkin_title_hint': 'ما الذي تريد متابعته اليوم؟',
      'quick_checkin': 'تحقق سريع',
      'checkin_empty': 'لا توجد مهام يومية بعد',
